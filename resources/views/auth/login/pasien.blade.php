...
<div class="flex flex-col lg:flex-row h-screen">
    ...
    <div 
        class="hover:scale-110 transition duration-300 ease-in-out rounded-xl shadow m-1 lg:w-1/2 w-full h-64 lg:h-auto bg-cover bg-center"
    ...
    <div class="lg:w-1/2 w-full p-4 lg:p-8 flex items-center justify-center">
        <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
            <div class="px-6 py-4">
                ...
                <form method="POST" action="{{ route('login.pasien') }}" class="mt-6">
                    @csrf
                    ...
                    <div class="flex items-center justify-between">
                        <button 
                            type="submit" 
                            class="hover:scale-110 transition duration-300 ease-in-out w-full px-4 py-2 text-white bg-primary hover:bg-secondary rounded-lg focus:ring focus:ring-primary focus:outline-none transition"
                        >
                            {{ __('Login') }}
                        </button>
                    </div>
            ...
            <div class="px-6 py-4 bg-gray-100 dark:bg-gray-700 text-sm text-center m-5">
