...
<div class="flex flex-col lg:flex-row h-screen">
    ...
    <div 
        class="rounded-xl shadow m-1 lg:w-1/2 w-full h-64 lg:h-auto bg-cover bg-center hover:scale-110 transition duration-300 ease-in-out"
            ...
            <div class="px-6 py-4">
                ...
                <form method="POST" action="{{ route('login.admin') }}" class="mt-6">
                    ...
                    <div class="flex items-center justify-between">
                        <button 
                            type="submit" 
                            class="w-full px-4 py-2 text-white bg-primary hover:bg-secondary rounded-lg focus:ring focus:ring-primary focus:outline-none transition hover:scale-110 transition duration-300 ease-in-out"
                        >
                            {{ __('Login') }}
                        </button>
                    </div>
