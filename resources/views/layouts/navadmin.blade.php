<nav class="bg-background rounded-xl shaadow m-1 items-center dark:bg-gray-900 w-full z-20 top-0 start-0 border-b border-secondary dark:border-gray-600">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="flex md:order-2 space-x-4 rtl:space-x-reverse">
        <button onclick="window.location.href='{{ route('register.admin') }}'" type="button" class="hover:scale-110 transition duration-300 ease-in-out text-accent font-bold bg-primary hover:bg-secondary focus:ring-4 focus:outline-none focus:ring-secondary font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-primary dark:hover:bg-secondary dark:focus:ring-secondary dark:text-background">
          Get Started
        </button>
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
        <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-secondary rounded-lg bg-accent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-background dark:bg-gray-800 dark:border-gray-700">
          <li>
            <a href="{{ route('homeadmin') }}" class="block py-2 px-3 text-accent bg-secondary rounded md:bg-transparent md:text-accent md:p-0 hover:text-primary dark:hover:bg-secondary dark:text-accent dark:hover:text-background transition-all">
              Home
            </a>
          </li>
        </ul>
