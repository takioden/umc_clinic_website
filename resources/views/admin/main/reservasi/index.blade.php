    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg mt-14">
        <div class="container mx-auto p-4">
            <div class="bg-white shadow-md rounded-lg p-6">
                <!-- Judul Daftar Pasien -->
                <h1 class="text-2xl font-semibold mb-4 text-center">Daftar Pasien</h1>

                <form method="GET" action="{{ route('search.pasien') }}" class="mb-6 flex justify-center">
                            ...
                            @foreach ($pasien as $p)
                                <tr>
                                    ...
                                    <td class="border p-2 text-center">
                                        <a href="{{ route('riwayat.periksa', $p->id) }}" 
