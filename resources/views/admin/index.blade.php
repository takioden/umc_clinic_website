...
<div class="flex flex-col md:flex-row h-screen">
    ...
    <div 
        class="md:w-1/2 rounded-xl shadow m-1 h-1/3 md:h-full bg-cover bg-center hover:scale-110 transition duration-300 ease-in-out"
        ...
        <div class="text-center space-y-6">
            ...
            <div class="flex flex-col md:flex-row gap-4 justify-center">
                <a 
                    ...
                    class="hover:scale-110 transition duration-300 ease-in-out w-full md:w-auto px-4 py-2 text-white bg-primary hover:bg-secondary rounded-lg text-sm font-medium text-center"
                >
                    Login
                </a>
                <a 
                    href="{{ route('register.admin') }}" 
                    class="hover:scale-110 transition duration-300 ease-in-out w-full md:w-auto px-4 py-2 text-primary border border-primary hover:border-secondary hover:bg-secondary hover:text-white rounded-lg text-sm font-medium text-center"
                >
                    Register
                </a>
            </div>
